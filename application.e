...
feature {NONE} -- Initialization
	...
	prepare
		...
		do
			...
			add_employee_button.select_actions.extend (agent add_employee)
...
feature
	...
	add_employee
		...
		do
			create employeeTest.make_with_arguments ("John Doe", "Engineer", "Mike H")
			IO.put_string ("Name: " + employeeTest.name)
		end
...
feature {NONE} -- Implementation
	...
	first_window: EV_WINDOW -- The main window of the application
